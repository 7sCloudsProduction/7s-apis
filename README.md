...
![7sClouds Api's Screenshot](image.png)
...
1. Clone this repository to your web server:
   ```bash
   git clone https://github.com/7sCloudsProduction/7sCloudsAPIs.git
   ```

2. Configure your API endpoints in `settings.json` (see Configuration section below)

3. Access the UI through your web server (e.g., `https://your-domain.com/ngetod.git/`)
...
Created with ❤️ by [Alpiannn7sClouds](https://github.com/7sCloudsProduction)
